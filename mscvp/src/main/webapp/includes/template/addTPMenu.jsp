 ...
 <%
         ...
         <%-- <li class="current"><a href="<s:url action="../tp/addTP"/>">Trading Partner</a></li> --%>
          <li><a href="#">Trading Partner<span class="sf-arrow"></span></a>
              <ul style="width:100px">
                  <li style="width:128px" class="current"><a href="<s:url action="../tradingPartner/addTradingPartner"/>" >Add&nbsp;TP</a></li>
                  
                  <li style="width:128px" class="notselected"><a href="<s:url action="../tradingPartner/doSearchTp"/>">TP&nbsp;Search</a></li>
              </ul> 
          <%}%>
