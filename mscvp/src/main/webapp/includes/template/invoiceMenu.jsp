<%-- 
    Document   : invoiceMenu
    Created on : Apr 16, 2013, 10:50:37 PM
    Author     : miracle
--%>
...
<%
         ...
         <ul >
          ...
          %>
          <li class="current"><a href="#">Financials<span class="sf-arrow"></span></a>
              <ul style="width:100px">
                  <li style="width:98px" class="current"><a href="<s:url action="../inv/invoiceAction"/>">Invoices</a></li>
                   <li style="width:98px" class="notselected"><a href="<s:url action="../payment/paymentAction"/>">Payments</a></li>
