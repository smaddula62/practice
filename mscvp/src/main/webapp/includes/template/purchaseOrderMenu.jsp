<%-- 
    Document   : purchaseOrderMenu
    Created on : Apr 16, 2013, 10:47:14 PM
    Author     : miracle
--%>
...
<li><a href="<s:url action="../doc/orderToCash"/>">Document Repository</a></li>
     <%
          ...
          %>
         <li class="current"><a href="#">Order Management<span class="sf-arrow"></span></a>
         <ul >
             <li class="current"><a href="<s:url action="../po/purchaseOrder"/>">Purchase Order</a></li>
            </ul>
          </li>
          <%}
